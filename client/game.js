Template.game.rendered = function () {
  ...
  PhaserGame.prototype = {
      ...
      create: function () {
          ...
          this.enemies.push(this.add.sprite(64, 200, 'player'));
      ...
      update: function () {
          ...
          this.physics.arcade.collide(this.weapons, this.enemies, this.collisionCheck, null, this);

      },

      collisionCheck: function (enemy, bullet, that) {
        console.log(enemy);
        console.log(bullet);
      }
